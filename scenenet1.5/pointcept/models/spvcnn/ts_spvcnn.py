...
class SPVCNN(nn.Module):
    ...
    def _process_batch(self, inpt:torch.Tensor):
        """
        ...
        batch = torch.cat([torch.full((inpt.shape[1],), i) for i in range(inpt.shape[0])], dim=0)
    ...
    def forward(self, inpt):
        ...
        discrete_coord, feat, batch = self._process_batch(inpt)
...
if __name__ == '__main__':
    ...
    model = SPVCNN(in_channels, num_classses)
