...
sys.path.insert(0, '..')
sys.path.insert(1, '../../..')
from criterions.w_mse import WeightedMSE, HIST_PATH
from criterions.geneo_loss import GENEO_Loss


class QuantileLoss(WeightedMSE):


    def __init__(self, targets: torch.Tensor, qs=torch.tensor([0.05, 0.5, 0.95]), 
