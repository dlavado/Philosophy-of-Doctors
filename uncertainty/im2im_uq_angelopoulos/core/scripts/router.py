...
from core.models.trunks.my_unet import UNet
# Models
...
from core.datasets.TS40K.ts40k import TS40KDataset_Unsupervised
...
if __name__ == "__main__":
  ...
  if wandb.config["dataset"] == "CIFAR10":
    ...
    if "didi" in str(os.getcwd()):
      path = "/media/didi/TOSHIBA EXT/TS40K/"
    else:
      path = "/home/d.lavado/TS40K/" #cluster data dir
   
    dataset = TS40KDataset_Unsupervised(path, split='samples', downsample=wandb.config["downsampling_factor"])
