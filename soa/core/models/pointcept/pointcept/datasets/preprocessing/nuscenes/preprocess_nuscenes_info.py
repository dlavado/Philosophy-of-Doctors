...
if __name__ == "__main__":
    ...
    print(available_scene_names_trainval)
    ...
    train_scenes = set(
        [
            ...
            for s in train_scenes if s in available_scene_names_trainval
        ]
    )
    test_scenes = splits.train
    test_scenes = set(
        [
            available_scenes_test[available_scene_names_test.index(s)]["token"]
            for s in test_scenes if s in available_scene_names_test
        ]
    )
